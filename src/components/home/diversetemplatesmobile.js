...
const DiverseTemplatesMobile = () => {
    return(
        <ContainerDiverse>
            <TextMiddle>
            <p style={{fontFamily:"HelveticaNeue-Medium.ttf", fontSize:"30px",paddingLeft:"28px",textAlign:"center",paddingTop:"20px"}}>Over 35 diverse<br/> templates on hand</p>
            <p style={{fontFamily:"HelveticaNeue-Regular.ttf",fontSize:"18px",paddingTop:"30px", textAlign:"center",paddingLeft:"40px"}}>Mockup covers various templates to help <br/> you envision your project within its <br/> intended frame. It offers more than 35 <br/> distinct options to choose from including:</p>
              <ListServices>
              <div>
              ...
              <ListServicesTwo>
                ...
                <li style={{listStyle:"none",display:"inline", border: "1px solid black", width:"16px",height:"12px",borderRadius:"10px",textAlign:"center",paddingLeft:"0px",paddingRight:"9px",marginRight:"5px"}}>&nbsp; &nbsp;Blank Template</li>
                </ul>
