...
const DiverseTemplatesIpad = () => {
    return(
        <ContainerDiverse>
            ...
            <p style={{fontFamily:"HelveticaNeue-Regular.ttf",fontSize:"18px",paddingTop:"30px", textAlign:"center"}}>Mockup covers various templates to help <br/> you envision your project within its <br/> intended frame. It offers more than 35 <br/> distinct options to choose from including:</p>
              <ListServices>
              <div>
