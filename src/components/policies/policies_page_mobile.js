...
const PoliciesPage = ({screenWidth}) => {
  return (
    <Container>
      <h1 style={{fontFamily:"HelveticaNeue-Medium" ,fontSize:"34px",marginTop:"80px",paddingLeft:"70px"}}><Circle text='Mockup' src={CircleSketchOut} width='160' top='-2' left='-12'  /> <Underline text='Policies' src={UnderlinePaper} width='140' bottom='-20' left='-2' /></h1>
